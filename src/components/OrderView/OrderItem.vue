    ...
    <div class="w-full">
      ...
      <div class="flex justify-between items-center mt-2">
        <div class="flex gap-1">
          <OrderStatus :time="getTimeFromProduct(1, orderItem.included.statuses.data)" :status="1" :active-status="orderItem.attributes.status.value">
            <OrderIcon color="black" width="16" height="16"></OrderIcon>
          </OrderStatus>
          <div class="h-[2px] mt-4 rounded min-w-[22px] bg-black"></div>
          <OrderStatus :time="getTimeFromProduct(2, orderItem.included.statuses.data)"  :status="2" :active-status="orderItem.attributes.status.value">
            <CookingIcon color="black" width="16" height="16"></CookingIcon>
          </OrderStatus>
          <div class="h-[2px] mt-4 rounded min-w-[22px] bg-black"></div>
          <OrderStatus :time="getTimeFromProduct(3, orderItem.included.statuses.data)" :active-status="orderItem.attributes.status.value" :status="3">
