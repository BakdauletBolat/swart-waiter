...
const show = defineModel('show');
  const histories = [{
      title: "Акция дня!",
      description: "Оплатите ваш заказ онлайн kaspi или картой официанту и получите скидку.\n" +
          "Скидка может быть не более 2000 ₸",
      url: "https://s3-alpha-sig.figma.com/img/858a/7847/6be673bade7f767219bc00158f755c5f?Expires=1712534400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=g-gNLx5zVSEZ0SCwEuiGJZSH3RqZkwW6llvaf4Odt9ACxRo6AsL7BwKFeYcR0NX6D4xwO3cOgQk5unqWphXx4NMDJHiXvOlIO745OuMbAYSum952pzgUT352n1W0~HWaHR7oHzmw4RdsZKzqScqjtV48qX33aScmEX8KAdVZSqk-VhsN4XgoY5akRGT1lEHhA0YmDa~kwWn1a2jqI62YT3AebwR~ScHav0I975OEEJO2ZVcaru6f4oWiZVdfJfgEmHoapnAdzIsltNHL4joRU63y~p1IucOitb-z1jVSl0GTbcmkGOiYOapSpe5qZV6Tbx3lBy52oR-wZiaaBiZg5A__"
  },
    {
      title: "Акция дня! 1",
      description: "Оплатите ваш заказ онлайн kaspi или картой официанту и получите скидку.\n" +
