...
<template>
  ...
  <vue-bottom-sheet ref="myBottomSheet">
    <div class="p-4">
      ...
      <div class="mt-4">
        <div class="bg-[#F4F4F6] px-[8px] py-[12px] flex items-center rounded-2xl">
          <div class="flex gap-4 items-center">
            <CashIcon width="40" height="40"></CashIcon>
            <div>Наличными официанту</div>
          </div>
        </div>
        <div class="bg-[#F4F4F6] px-[8px] py-[12px] flex items-center mt-2 rounded-2xl">
          <div class="flex gap-4 items-center">
      ...
      <div class="mt-4">
        <Button  class="w-full !rounded-2xl !p-4">
          <template #prepend>
