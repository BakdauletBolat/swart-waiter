<template>
    <div class="flex overflow-hidden justify-center items-center">
        <div v-if="!url" class="w-[100px] h-[100px]">
            <svg width="100%" height="100%" viewBox="0 -2 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="w-full h-full" v-else>
            <img class="w-full object-cover h-full" :src="url" />
        </div>
    </div>
</template>
